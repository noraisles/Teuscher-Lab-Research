...
X_train, X_val, y_train, y_val = train_test_split(X_train_val, y_train_val, test_size=0.25, random_state=101) # 0.25 * 0.8 = 0.2

# Train and evaluate Logistic Regression on the training set
